<?php
/**
 * ENHANCED WORDPRESS BUTTON INTEGRATION
 * Copy this entire code and paste it into your functions.php file
 * This replaces any existing meal planner code you have
 */
